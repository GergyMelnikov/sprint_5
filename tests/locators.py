...
class Main_page_locators():
    SIGN_IN_BUTTON = (By.XPATH, '/html/body/div/div/main/section[2]/div/button')

class Registration_form_locators():
    PASSWORD_FIELD = (By.CSS_SELECTOR, 'input[type="password"]')
    SUBMIT_BUTTON = (By.CSS_SELECTOR, 'button[class="button_button__33qZ0 button_button_type_primary__1O7Bx button_button_size_medium__3zxIa"]')
    NAME_FIELD = (By.XPATH, '/html/body/div/div/main/div/form/fieldset[1]/div/div/input')
    EMAIL_FIELD = (By.XPATH, '/html/body/div/div/main/div/form/fieldset[2]/div/div/input')